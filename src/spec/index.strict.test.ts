...
describe('strict', () => {
    ...
    describe('assume objects', () => {
        ...
        it('should error on missing context', () => {
            expectTemplate('{{hello}}').withCompileOptions({ assumeObjects: true }).withInput(undefined).toThrow(Error);
        });
        ...
        it('should execute blockHelperMissing', () => {
            expectTemplate('{{^hello}}foo{{/hello}}').withCompileOptions({ assumeObjects: true }).toCompileTo('foo');
        });
    });
});
